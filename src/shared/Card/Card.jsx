    ...
    <section className="grid grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-12">
      <Link to="/product">
        <div className="relative p-1 text-center group transform duration-500 cursor-pointer">
          ...
          <img className="rounded-md" src="https://i.postimg.cc/YCYzjf8L/1716107102-404977792-IMG20240515193224-800x800.jpg" alt="" />

          <h1 className="md:text-xl text-lg my-5 font-semibold">All Over Multi Stone Work Gorgeous 4 Part Party</h1>
          <p>
          ...
          <div className=" flex justify-center mt-2">
            <svg className="w-4 h-4 mx-px fill-current text-[#27aae1]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
          ...
          <div className="mt-8 flex md:flex-row flex-col gap-3 items-center justify-center">
            <div className="flex">
              <div className="text-2xl border px-3 py-1 border-l-2 rounded-l-full font-bold">-</div>
              <input className="border w-8 text-center" type="text" defaultValue={1} />
              <div className="text-2xl border px-3 py-1 border-l-2 rounded-r-full font-bold">+</div>
            </div>
            <div>
              <Link to="/cart">
