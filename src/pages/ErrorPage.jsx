  ...
  return (
    <>
      ...
      <div
        ...
        className="relative bg-no-repeat lg:bg-cover bg-center lg:bg-right-top  h-[80vh] lg:m-20 m-5 text-white lg:text-6xl text-xl font-bold text-center xl:pt-44 lg:pt-32 pt-44">
